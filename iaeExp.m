...
%     end
    ...
    if i==1
        iae_xy=iae_xy+(abs(robotPositionError(1,i))+abs(robotPositionError(2,i)))*timeReceive(i);
    else
        iae_xy=iae_xy+(abs(robotPositionError(1,i))+abs(robotPositionError(2,i)))*(timeReceive(i)-timeReceive(i-1));
    end
    
    if i==1
        iae_theta=iae_theta+abs(robotPositionError(3,i))*timeReceive(i);
    else
        iae_theta=iae_theta+abs(robotPositionError(3,i))*(timeReceive(i)-timeReceive(i-1));
    end  
end
