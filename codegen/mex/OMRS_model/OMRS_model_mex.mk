...
MAKEFILE = OMRS_model_mex.mk

include OMRS_model_mex.mki
...
MEX_FILE_NAME_WO_EXT = OMRS_model_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\OMRS_model"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\OMRS_model/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\OMRS_model/%.cpp
	$(CC) $(CPPFLAGS) "$<"
